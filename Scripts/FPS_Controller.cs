...
public class FPS_Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (PlayerManager.aimingDownSights == true)
        {
            float newRun = runSpeed / 4;
            float newWalk = walkSpeed / 4;
            speed = isRunning ? newRun : newWalk;
        }
        else
        {
        ...
        if (canMove && PauseMenu.gameIsPaused == false)
        {
